...
# ── 3‑3. 서술형 문제 3 표시 ──
QUESTION_3 = """
우리 몸은 물이 70%를 차지합니다. 그 이유는 무엇일지 물의 비열과 관련지어 설명하세요.
"""
...
# ── 1. 문항별 채점 기준 (교사가 수정) ──
GRADING_GUIDELINES = {
    1: "물에체 열을 가했을 때, 같은 시간동안 물체의 온도 변화가 크면 비열이 작다.",
    2: "같은 시간동안 식용유의 온도 변화가 크다. 따라서 식용유의 비열이 물보다 작다.",
    3: "우리 몸의 항상성 유지를 위해서 비열이 큰 물이 우리 몸의 대부분을 차지하여 체온을 유지할 수 있도록 한다."
}
